### CD into the file with vagrant in it and put in the command " sudo apt-get install python-software-properties
...
### when that's finished put in the code " curl -sL https://deb.nodesource.com/setup_6.x | sudo -E bash -"
...
### Put in the code "sudo apt-get install nodejs -y"
...
### Put in the code "sudo npm install pm2 -g"
...
### Cd into your app then put in the codes " npm install " then put in "npm start"
